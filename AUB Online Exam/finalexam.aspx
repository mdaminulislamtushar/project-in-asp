<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="finalexam.aspx.cs" Inherits="WebApplication4.question" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>AUBSkillTest -Final Exam</title>
                        ...
                        <div class="col-3 col-lg-9 flex justify-content-end align-content-center">
                            <nav class="site-navigation flex justify-content-end align-items-center">
                                <ul class="flex flex-column flex-lg-row justify-content-lg-end align-content-center">
                                    ...
                                    <li>
                                        <asp:HyperLink ID="HyperLink6" runat="server" ForeColor="White" NavigateUrl="~/exam.aspx">Exam</asp:HyperLink>
                                     </li>
                                    <li>
