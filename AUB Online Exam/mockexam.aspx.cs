...
{
    public partial class mockexam : System.Web.UI.Page
    {
        private string path;
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            cn.Open();
            string count = "select countofresult from mockexamquery where user_id = '"+uid+"'";
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "insert into mockexam(user_id,code,q_no,correct_ans,dateofexam) values('" + uid + "','" + c + "'," + n + "," + answ + ",'" + doe + "')";
            cmd.ExecuteNonQuery();
            cn.Close();
        }
